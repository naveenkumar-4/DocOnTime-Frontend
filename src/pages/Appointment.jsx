...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    if (!docInfo || !docInfo.slots_booked) {
      console.log("Doctor info or slots not available yet.");
      return;
    }
    setDocSlots([])
  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-primary text-white tex-sm font-light px-14 py-3 rounded-full my-6'>
          Book an Appointment
        </button>
      </div>
